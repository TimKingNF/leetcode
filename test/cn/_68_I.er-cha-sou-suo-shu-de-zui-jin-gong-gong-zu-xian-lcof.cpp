...
#include "header.h"
#include "_68_I.er-cha-sou-suo-shu-de-zui-jin-gong-gong-zu-xian-lcof.h"

namespace LeetCode_68_I {
...
class LeetCode_68_ITest : public ::testing::TestWithParam<ParamType> {
  // You can implement all the usual fixture class members here.
  // To access the test parameter, call GetParam() from class
  // TestWithParam<T>.
};

TEST_P(LeetCode_68_ITest, main) {
  // Inside a test, access the test parameter with the GetParam() method
  // of the TestWithParam<T> class:

  auto solution = new LeetCode_68_I::Solution();
...
INSTANTIATE_TEST_SUITE_P(LeetCode_68_IParamTest, LeetCode_68_ITest, values);
