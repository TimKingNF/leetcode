...
class LeetCode240Test : public ::testing::TestWithParam<ParamType> {
  // You can implement all the usual fixture class members here.
  // To access the test parameter, call GetParam() from class
  // TestWithParam<T>.
};

TEST_P(LeetCode240Test, main) {
  // Inside a test, access the test parameter with the GetParam() method
  // of the TestWithParam<T> class:

  auto solution = new LeetCode240::Solution();
  ...
  ASSERT_EQ(solution->searchMatrix(matrix, target), ret);  // 断言结果
}
...
INSTANTIATE_TEST_SUITE_P(LeetCode240ParamTest, LeetCode240Test, values);
