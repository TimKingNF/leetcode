...
#include "header.h"
#include "_41.shu-ju-liu-zhong-de-zhong-wei-shu-lcof.h"
...
class LeetCode_41Test : public ::testing::TestWithParam<ParamType> {
  // You can implement all the usual fixture class members here.
  // To access the test parameter, call GetParam() from class
  // TestWithParam<T>.
};

TEST_P(LeetCode_41Test, main) {
...
INSTANTIATE_TEST_SUITE_P(LeetCode_41ParamTest, LeetCode_41Test, values);
