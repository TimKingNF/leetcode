...
#include "header.h"
#include "_52.liang-ge-lian-biao-de-di-yi-ge-gong-gong-jie-dian-lcof.h"
...
class LeetCode_52Test : public ::testing::TestWithParam<ParamType> {
  // You can implement all the usual fixture class members here.
  // To access the test parameter, call GetParam() from class
  // TestWithParam<T>.
};

TEST_P(LeetCode_52Test, main) {
  // Inside a test, access the test parameter with the GetParam() method
  // of the TestWithParam<T> class:

  auto solution = new LeetCode_52::Solution();
...
INSTANTIATE_TEST_SUITE_P(LeetCode_52ParamTest, LeetCode_52Test, values);
