...
#include "header.h"
#include "_19.zheng-ze-biao-da-shi-pi-pei-lcof.h"
...
class LeetCode_19Test : public ::testing::TestWithParam<ParamType> {
  // You can implement all the usual fixture class members here.
  // To access the test parameter, call GetParam() from class
  // TestWithParam<T>.
};

TEST_P(LeetCode_19Test, main) {
  // Inside a test, access the test parameter with the GetParam() method
  // of the TestWithParam<T> class:

  auto solution = new LeetCode_19::Solution();
...
INSTANTIATE_TEST_SUITE_P(LeetCode_19ParamTest, LeetCode_19Test, values);
