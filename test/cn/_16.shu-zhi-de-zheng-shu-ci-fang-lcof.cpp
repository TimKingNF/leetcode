...
#include "header.h"
#include "_16.shu-zhi-de-zheng-shu-ci-fang-lcof.h"
...
class LeetCode_16Test : public ::testing::TestWithParam<ParamType> {
  // You can implement all the usual fixture class members here.
  // To access the test parameter, call GetParam() from class
  // TestWithParam<T>.
};

TEST_P(LeetCode_16Test, main) {
  // Inside a test, access the test parameter with the GetParam() method
  // of the TestWithParam<T> class:

  auto solution = new LeetCode_16::Solution();
...
INSTANTIATE_TEST_SUITE_P(LeetCode_16ParamTest, LeetCode_16Test, values);
