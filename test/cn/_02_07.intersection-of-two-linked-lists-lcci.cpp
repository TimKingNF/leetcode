...
#include "header.h"
#include "_02_07.intersection-of-two-linked-lists-lcci.h"

namespace LeetCode_02_07 {
...
class LeetCode_02_07Test : public ::testing::TestWithParam<ParamType> {
  // You can implement all the usual fixture class members here.
  // To access the test parameter, call GetParam() from class
  // TestWithParam<T>.
};

TEST_P(LeetCode_02_07Test, main) {
  // Inside a test, access the test parameter with the GetParam() method
  // of the TestWithParam<T> class:

  auto solution = new LeetCode_02_07::Solution();
...
INSTANTIATE_TEST_SUITE_P(LeetCode_02_07ParamTest, LeetCode_02_07Test, values);
